...
You must create your own instance of the Conversation service, configure Intu to use your service credentials, and import a workspace for the service.
...
2. Click on the big download arrow for **Download Intu Starter Kit** and extract the contents of the zip file into a working directory. 
...
5. Click the **Import** icon next to the green Create button.
...
6. Test your change.
  1. In the **Enter something to test your bot** field at the bottom of the **Try it out** panel, type Hello, and press **Enter**. Submit hello a few times until your new response is returned. Note that Conversation may take a few minutes to train, as indicated by the pop-up message: **Watson is training on your recent changes** in purple.
...
4.	Return to the [Watson Intu Gateway](https://rg-gateway.mybluemix.net/).
